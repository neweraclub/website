...
export const TiltCard: React.FC<TiltCardProps> = ({
  ...
  return (
    ...
    >
      {/* Glossy Glare effect following mouse */}
      {isHovered && (
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 0.25 }}
          exit={{ opacity: 0 }}
          className="pointer-events-none absolute inset-0 rounded-2xl bg-gradient-to-tr from-white via-transparent to-transparent z-20"
        />
      )}
